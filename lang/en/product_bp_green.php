...
return [
    ...
    'point' => [
        '1' => [
            'title' => 'Main Benefits:',
            'description' => '<ul><li>Supports children’s brain development</li><li>Boosts immunity</li><li>Increases appetite</li><li>Helps concentration and memory</li><li>Improves blood flow to the brain</li></ul>',
        ],
        '2' => [
            'title' => 'Product Information:',
            'description' => '<ul><li>Net content: 6 ml</li><li>BPOM: TR193631981</li><li>Halal Certificate MUI: 0013009335019</li><li>Halal Certificate UK (HMC): 2018-196</li><li>FDA Certificate</li><li>Shelf life: Up to 3 years</li></ul>',
        ],
    ],
    'cta' => 'Order Now',
];
