...
return [
    ...
    'point' => [
        '1' => [
            ...
            'description' => '<ul><li>Supports brain development and cognitive function</li><li>Reduces allergy symptoms</li><li>Helps relieve asthma</li><li>Maintains heart health</li></ul>',
        ],
        '2' => [
            'title' => 'Advantages',
            'description' => '<ul><li>Maintains heart health</li><li>Reduces the risk of dementia in the elderly</li></ul>',
            'info' => 'Contents: 40 clear soft capsules',
        ],
    ],
    'cta' => 'Order Now',
];
