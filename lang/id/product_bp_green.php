...
return [
    ...
    'point' => [
        '1' => [
            'title' => 'Manfaat Utama',
            'description' => '<ul><li>Mendukung perkembangan otak anak</li><li>Meningkatkan daya tahan tubuh</li><li>Meningkatkan nafsu makan</li><li>Membantu konsentrasi dan daya ingat</li><li>Melancarkan aliran darah ke otak</li></ul>',
        ],
        '2' => [
            'title' => 'Informasi Produk',
            'description' => '<ul><li>Isi bersih: 6 ml</li><li>BPOM: TR193631981</li><li>Sertifikat Halal MUI: 0013009335019</li><li>Sertifikat Halal UK (HMC): 2018-196</li><li>Sertifikat FDA</li><li>Masa simpan: Hingga 3 tahun</li></ul>',
        ],
    ],
    'cta' => 'Pesan Sekarang',
];
