    ...
    public function run(): void
    {
        $data = [
            [
                ...
                'category' => 'blog',
                'image' => 'storage/news/Manis Tanpa Rasa Bersalah.webp',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'category' => 'blog',
                'image' => 'storage/news/Tips & Trik Konsumsi Steffi.webp',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'category' => 'blog',
                'image' => 'storage/news/Gula Berlebih Manisnya Sekarang, Risikonya Nanti.webp',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
