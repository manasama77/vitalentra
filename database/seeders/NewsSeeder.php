    ...
    public function run(): void
    {
        $data = [
            [
                ...
                'category' => 'blog',
                'image' => 'storage/news/Manis Tanpa Rasa Bersalah.png',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'category' => 'blog',
                'image' => 'storage/news/Tips & Trik Konsumsi Steffi.png',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'category' => 'blog',
                'image' => 'storage/news/Gula Berlebih Manisnya Sekarang, Risikonya Nanti.png',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
