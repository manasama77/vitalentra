            ...
            <div class="row">
                <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                    <div class="group hover:-translate-y-1">
                        ...
                        <div class="w-full">
                            <h4 class="text-xl/tight font-semibold mb-5">
                                Refreshing Design
                            </h4>
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit.
...
-369 155 32 275 190 260 339 -11 105 -90 213 -190 262 -61 29 -155 36 -217 16z" />
            ...
            <div class="row">
                    ...
                    <article class="group">
                        <div class="relative">
                            <a href="javascript:void(0)" class="w-full aspect-3/2 rounded-xl overflow-hidden block">
                                <img src="./assets/img/thumbnail/thumbnail-1.jpg" alt="Thumbnail"
                                    class="w-full h-full object-cover group-hover:scale-[1.05] group-hover:rotate-2" />
                            </a>
                        </div>
                ...
                <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                    <article class="group">
                        <div class="relative">
                            <a href="javascript:void(0)" class="w-full aspect-3/2 rounded-xl overflow-hidden block">
                                <img src="./assets/img/thumbnail/thumbnail-2.jpg" alt="Thumbnail"
                                    class="w-full h-full object-cover group-hover:scale-[1.05] group-hover:rotate-2" />
                            </a>
                        </div>
                        <span class="block mt-6 w-full text-sm text-body-light-10 dark:text-body-dark-10">Joe Russell -
                ...
                <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                    <article class="group">
                        <div class="relative">
                            <a href="javascript:void(0)" class="w-full aspect-3/2 rounded-xl overflow-hidden block">
                                <img src="./assets/img/thumbnail/thumbnail-3.jpg" alt="Thumbnail"
                                    class="w-full h-full object-cover group-hover:scale-[1.05] group-hover:rotate-2" />
                            </a>
                        </div>
                        <span class="block mt-6 w-full text-sm text-body-light-10 dark:text-body-dark-10">Joe Russell -
    ...
    <!-- Map section -->
    <section id="map" class="w-full h-[500px] overflow-hidden -mt-48">
        <object
