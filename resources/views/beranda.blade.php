<x-layouts.landing>
    ...
    <x-landing.partials.modal_figure modalId="{{ Str::slug('Marida') }}" name="Marida" position="Chairman of the Board"
        photo="{{ Vite::asset('resources/images/Management - Marida.webp') }}" content="{!! __('team.content.1') !!}" />
    ...
    <x-landing.partials.modal_figure modalId="{{ Str::slug('M. Nuzullaiman') }}" name="M. Nuzullaiman" position="Chief Executive Officer"
        photo="{{ Vite::asset('resources/images/Management - M. Nuzullaiman.webp') }}" content="{!! __('team.content.3') !!}" />
    ...
    <x-landing.partials.modal_figure modalId="{{ Str::slug('Renya Nuringtyas') }}" name="Renya Nuringtyas" position="Chief Marketing Officer"
        photo="{{ Vite::asset('resources/images/Management - Renya Nuringtyas.webp') }}" content="{!! __('team.content.5') !!}" />
</x-layouts.landing>
