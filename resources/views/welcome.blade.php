    ...
    <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
        <main class="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div
                ...
                {{-- Light Mode 12 SVG --}}
                <svg class="relative -ms-8 -mt-[4.9rem] w-[448px] max-w-none lg:-mt-[6.6rem] lg:ms-0 dark:hidden" viewBox="0 0 440 376" fill="none"
                ...
                {{-- Dark Mode 12 SVG --}}
                <svg class="relative -ms-8 -mt-[4.9rem] hidden w-[448px] max-w-none lg:-mt-[6.6rem] lg:ms-0 dark:block" viewBox="0 0 440 376"
