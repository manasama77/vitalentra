            ...
            <div class="text-center">
                ...
                <nav aria-label="Breadcrumb" class="mb-6">
                    <ol class="flex items-center justify-center gap-2 text-sm text-neutral-600">
                        ...
                        <li>
                            <a href="{{ route('news.list') }}" class="hover:text-primary text-secondary transition-colors">
                ...
                <!-- Meta Information -->
                <div class="scroll-revealed flex flex-col items-center justify-center gap-4 text-neutral-600 sm:flex-row sm:gap-8">
        ...
        <div class="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            @if ($news->image)
                <div class="scroll-revealed mb-12 overflow-hidden rounded-2xl shadow-lg">
                    <img src="{{ asset($news->image) }}" alt="{{ $news->title }}"
                        class="h-auto w-full object-contain md:h-80 md:object-cover lg:h-96" loading="lazy">
                </div>
            @endif
            ...
            <div class="scroll-revealed mt-12 border-t border-neutral-200 pt-8">
                <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="flex flex-wrap gap-3 md:flex-shrink-0" role="group" aria-label="Share options">
                        <!-- Facebook Share -->
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->fullUrl()) }}" target="_blank"
                            rel="noopener noreferrer" class="btn btn-circle btn-outline btn-sm hover:btn-primary flex-shrink-0"
                            aria-label="Share on Facebook">
                            <i class="fab fa-facebook-f" aria-hidden="true"></i>
                        </a>
                        <!-- Twitter Share -->
                        <a href="https://twitter.com/intent/tweet?url={{ urlencode(request()->fullUrl()) }}&text={{ urlencode($news->title) }}"
                            target="_blank" rel="noopener noreferrer" class="btn btn-circle btn-outline btn-sm hover:btn-primary flex-shrink-0"
                            aria-label="Share on Twitter">
                            <i class="fab fa-twitter" aria-hidden="true"></i>
                        </a>
                        <!-- Instagram Share -->
                        <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"
                            class="btn btn-circle btn-outline btn-sm hover:btn-primary flex-shrink-0" aria-label="Share on Instagram">
                            <i class="fab fa-instagram" aria-hidden="true"></i>
                        </a>
                        <!-- WhatsApp Share -->
                        <a href="https://wa.me/?text={{ urlencode($news->title . ' - ' . request()->fullUrl()) }}" target="_blank"
                            rel="noopener noreferrer" class="btn btn-circle btn-outline btn-sm hover:btn-primary flex-shrink-0"
