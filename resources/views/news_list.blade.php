            ...
            <div class="scroll-revealed container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                @if ($news->count() > 0)
                    @if ($news->currentPage() == 1)
                        ...
                        <div class="mb-16">
                            <div
                                class="scroll-revealed group overflow-hidden rounded-2xl bg-white shadow-lg transition-shadow duration-300 hover:shadow-xl">
                                <div class="lg:flex">
                                    <!-- Featured Image -->
                                    <div class="lg:w-1/2">
                                        <div class="relative h-fit overflow-hidden md:h-fit">
                                            <img src="{{ asset($featuredNews->image) }}" alt="{{ $featuredNews->title }}"
                                                class="group-hover:scale-102 h-full w-full object-contain transition-transform duration-300 md:object-contain"
                                                loading="eager">
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-col justify-center p-6 lg:w-1/2 lg:p-8">
                                        <div class="mb-4 flex items-center justify-between">
                                            ...
                                            <div>
                                                <div class="bg-primary text-primary-content rounded-full px-3 py-1 text-xs font-medium">
                                                    {{ strtoupper($featuredNews->category) }}
                                                </div>
                                            </div>
                                        </div>

                                        <h2 class="text-base-content mb-2 line-clamp-2 text-xl font-bold md:text-2xl">
                                ...
                                @foreach ($news->skip(1) as $n)
                                    <div
                                        ...
                                        <div class="card-body p-6">
                                            ...
                                            <h3 class="card-title line-clamp-2 text-xl font-semibold text-gray-900">
