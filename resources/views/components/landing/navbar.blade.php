<header class="ic-navbar absolute left-0 top-0 z-40 flex w-full items-center bg-transparent md:py-1" role="banner" aria-label="Navigation bar">
    <div class="container">
        <div class="ic-navbar-container relative -mx-5 flex items-center justify-between">
            <div class="w-20 max-w-full px-5 lg:w-20">
                ...
                <a href="{{ route('home') }}" class="ic-navbar-logo text-primary-color block w-full">
                    <img src="{{ $is_home ? Vite::asset('resources/images/logo_white.png') : Vite::asset('resources/images/logo.png') }}"
                        alt="Vitalentra Logo" class="w-full" id="NavbarBrandWhite" data-name="NavbarBrand">
                    <img src="{{ Vite::asset('resources/images/logo.png') }}" alt="Vitalentra Logo" class="hidden w-full" id="NavbarBrandDark"
            ...
            <div class="flex w-full items-center justify-between px-5">
                <div>
                    <button type="button"
                        class="ic-navbar-toggler absolute right-4 top-1/2 block -translate-y-1/2 rounded-md px-3 py-[6px] text-[22px]/none ring-white transition-colors duration-300 focus:ring-2 lg:hidden"
                        data-web-toggle="navbar-collapse" data-web-target="navbarMenu" aria-expanded="false" aria-label="Toggle navigation menu">
                ...
                <div class="flex items-center justify-end gap-6 pr-[52px] lg:pr-0">
                    <x-landing.language />
                    <button type="button" class="text-primary-color hidden items-center text-[22px]/none" aria-label="Switch theme"
