                ...
                <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
                    <div class="relative mx-auto w-full max-w-7xl overflow-hidden rounded-xl">
                        ...
                        <div class="relative h-[50vh] overflow-hidden md:h-[70vh]">
                            <!-- Slides -->
                            <div id="bp-norway-slides-container" class="flex h-full transition-transform duration-500 ease-in-out">
                                <div class="relative w-full flex-shrink-0">
                                    <img src="{{ Vite::asset('resources/images/products/british propolis norway/1.webp') }}" alt="Modern Architecture"
                                        class="h-full w-full object-cover">
                                </div>
                                <div class="relative w-full flex-shrink-0">
                                    <img src="{{ Vite::asset('resources/images/products/british propolis norway/2.webp') }}" alt="Nature Landscape"
                                        class="h-full w-full object-cover">
                                </div>
                                <div class="relative w-full flex-shrink-0">
                                    <img src="{{ Vite::asset('resources/images/products/british propolis norway/3.webp') }}" alt="City Skyline"
                                        class="h-full w-full object-cover">
                                </div>
                            </div>
            ...
            <div class="order-2 w-full min-w-0 space-y-4 overflow-hidden sm:space-y-6 lg:order-1">
                ...
                <div class="accordion divide-neutral/20 divide-y">
                    <div class="accordion-item" id="bp-norway-manfaat">
                        <button class="accordion-toggle inline-flex items-center gap-x-4 pl-0 text-start" aria-controls="bp-norway-manfaat-collapse"
                            aria-expanded="false">
                            <span
                        ...
                        <div id="bp-norway-manfaat-collapse" class="accordion-content hidden w-full overflow-hidden transition-[height] duration-300"
                            aria-labelledby="bp-norway-manfaat" role="region">
                    ...
                    <div class="accordion-item" id="bp-norway-kelebihan">
                        <button class="accordion-toggle inline-flex items-center gap-x-4 pl-0 text-start" aria-controls="bp-norway-kelebihan-collapse"
                            aria-expanded="false">
                            <span
                                class="icon-[tabler--chevron-right] accordion-item-active:rotate-90 size-5 shrink-0 transition-transform duration-300 rtl:rotate-180"></span>
                        ...
                        <div id="bp-norway-kelebihan-collapse"
                            ...
                            aria-labelledby="bp-norway-kelebihan" role="region">
                            <div class="prose prose-sm md:prose-md w-full max-w-none pb-4">
