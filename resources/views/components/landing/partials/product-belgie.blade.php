                ...
                <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
                    <div class="relative mx-auto w-full max-w-7xl overflow-hidden rounded-xl">
                        ...
                        <div class="relative h-[50vh] overflow-hidden md:h-[70vh]">
                            <!-- Slides -->
                            <div id="belgie-slides-container" class="flex h-full transition-transform duration-500 ease-in-out">
                                <div class="relative w-full flex-shrink-0">
                                    <img src="{{ Vite::asset('resources/images/products/belgie/1.webp') }}" alt="Belgie"
                                        class="h-full w-full object-cover">
                                </div>
                                <div class="relative w-full flex-shrink-0">
                                    <img src="{{ Vite::asset('resources/images/products/belgie/2.webp') }}" alt="Belgie"
                                        class="h-full w-full object-cover">
                                </div>
                                <div class="relative w-full flex-shrink-0">
                                    <img src="{{ Vite::asset('resources/images/products/belgie/3.webp') }}" alt="Belgie"
                                        class="h-full w-full object-cover">
                                </div>
                                <div class="relative w-full flex-shrink-0">
                                    <img src="{{ Vite::asset('resources/images/products/belgie/4.webp') }}" alt="Belgie"
                                        class="h-full w-full object-cover">
                                </div>
                                <div class="relative w-full flex-shrink-0">
                                    <img src="{{ Vite::asset('resources/images/products/belgie/5.webp') }}" alt="Belgie"
                                        class="h-full w-full object-cover">
                                </div>
                            </div>
            ...
            <div class="order-2 w-full min-w-0 space-y-4 overflow-hidden sm:space-y-6 lg:order-2">
                ...
                <div class="accordion divide-neutral/20 divide-y">
                    <div class="accordion-item" id="belgie-teknologi">
                        <button class="accordion-toggle inline-flex items-center gap-x-4 pl-0 text-start" aria-controls="belgie-teknologi-collapse"
                            aria-expanded="false">
                            <span
                        ...
                        <div id="belgie-teknologi-collapse" class="accordion-content hidden w-full overflow-hidden transition-[height] duration-300"
                            aria-labelledby="belgie-teknologi" role="region">
                    ...
                    <div class="accordion-item" id="belgie-rangkaian">
                        <button class="accordion-toggle inline-flex items-center gap-x-4 pl-0 text-start" aria-controls="belgie-rangkaian-collapse"
                            aria-expanded="false">
                            <span
                                class="icon-[tabler--chevron-right] accordion-item-active:rotate-90 size-5 shrink-0 transition-transform duration-300 rtl:rotate-180"></span>
                            {{ __('product_belgie.point.2.title') }}
                        </button>
                        <div id="belgie-rangkaian-collapse" class="accordion-content hidden w-full overflow-hidden transition-[height] duration-300"
                            aria-labelledby="belgie-rangkaian" role="region">
                            <div class="accordion divide-neutral/20 divide-y ps-6">
                                ...
                                <div class="accordion-item" id="belgie-facial-wash">
                                    <button class="accordion-toggle inline-flex items-center gap-x-4 pl-0 text-start"
                                        aria-controls="belgie-facial-wash-collapse" aria-expanded="false">
                                        <span
                                            class="icon-[tabler--chevron-right] accordion-item-active:rotate-90 size-5 shrink-0 transition-transform duration-300 rtl:rotate-180"></span>
                                    ...
                                    <div id="belgie-facial-wash-collapse"
                                        ...
                                        aria-labelledby="belgie-facial-wash" role="region">
                                        <div class="prose prose-sm md:prose-md w-full max-w-none pb-4">
                                ...
                                <div class="accordion-item" id="belgie-face-serum">
                                    <button class="accordion-toggle inline-flex items-center gap-x-4 pl-0 text-start"
                                        aria-controls="belgie-face-serum-collapse" aria-expanded="false">
                                        <span
                                            class="icon-[tabler--chevron-right] accordion-item-active:rotate-90 size-5 shrink-0 transition-transform duration-300 rtl:rotate-180"></span>
                                    ...
                                    <div id="belgie-face-serum-collapse"
                                        class="accordion-content hidden w-full overflow-hidden transition-[height] duration-300"
                                        aria-labelledby="belgie-face-serum" role="region">
                                        <div class="prose prose-sm md:prose-md w-full max-w-none pb-4">
                                ...
                                <div class="accordion-item" id="belgie-night-cream">
                                    <button class="accordion-toggle inline-flex items-center gap-x-4 pl-0 text-start"
                                        aria-controls="belgie-night-cream-collapse" aria-expanded="false">
                                        <span
                                            class="icon-[tabler--chevron-right] accordion-item-active:rotate-90 size-5 shrink-0 transition-transform duration-300 rtl:rotate-180"></span>
                                    ...
                                    <div id="belgie-night-cream-collapse"
                                        class="accordion-content hidden w-full overflow-hidden transition-[height] duration-300"
                                        aria-labelledby="belgie-night-cream" role="region">
                                        <div class="prose prose-sm md:prose-md w-full max-w-none pb-4">
                                ...
                                <div class="accordion-item" id="belgie-day-cream">
                                    <button class="accordion-toggle inline-flex items-center gap-x-4 pl-0 text-start"
                                        aria-controls="belgie-day-cream-collapse" aria-expanded="false">
                                        <span
                                            class="icon-[tabler--chevron-right] accordion-item-active:rotate-90 size-5 shrink-0 transition-transform duration-300 rtl:rotate-180"></span>
                                    ...
                                    <div id="belgie-day-cream-collapse"
                                        class="accordion-content hidden w-full overflow-hidden transition-[height] duration-300"
                                        aria-labelledby="belgie-day-cream" role="region">
                                        <div class="prose prose-sm md:prose-md w-full max-w-none pb-4">
                                ...
                                <div class="accordion-item" id="belgie-hair-tonic">
                                    <button class="accordion-toggle inline-flex items-center gap-x-4 pl-0 text-start"
                                        aria-controls="belgie-hair-tonic-collapse" aria-expanded="false">
                                        <span
                                            class="icon-[tabler--chevron-right] accordion-item-active:rotate-90 size-5 shrink-0 transition-transform duration-300 rtl:rotate-180"></span>
                                    ...
                                    <div id="belgie-hair-tonic-collapse"
                                        class="accordion-content hidden w-full overflow-hidden transition-[height] duration-300"
                                        aria-labelledby="belgie-hair-tonic" role="region">
                                        <div class="prose prose-sm md:prose-md w-full max-w-none pb-4">
