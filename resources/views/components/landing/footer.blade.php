                ...
                <div class="w-full">
                    ...
                    <form action="#" method="POST" target="_blank" class="mt-8 flex">
                        <input type="email" name="email"
                            class="inline-block grow px-5 py-3 rounded-md rounded-e-none border border-solid border-alpha-dark text-inherit text-base focus:border-primary"
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2">
                <div class="my-1 flex justify-center md:justify-end">
                    <p class="text-body-dark-11">
                        &#169; 2024 Inazuma Inc. All rights reserved. Distributed by <a href="https://themewagon.com"
