...
<div {{ $styleAttributes->class($classes) }} data-flux-input-file wire:ignore tabindex="0" x-data {{-- This is here to "scope" the x-ref references inside this component from interfering with others outside... --}}
    ...
    <div x-ref="name" class="cursor-default select-none truncate whitespace-nowrap text-sm font-medium text-zinc-500 dark:text-zinc-400"
        aria-hidden="true">
        {!! __('No file chosen') !!}
    </div>
</div>
